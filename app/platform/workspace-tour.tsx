...
const areas = [
  ...
  { id: "engagements", label: "Engagements", Icon: Layers3, href: "/workspace/engagements", c: "#7c3aed", t: "Turn an enquiry into a working brief", d: "Structured discovery entries, measured vs estimated baselines, a discovery request stage and a full event history.", rows: ["Discovery entry", "Baseline · measured", "Stage · discovery requested", "Event history"] },
  { id: "academy", label: "Academy", Icon: GraduationCap, href: "/workspace/academy", c: "#2563eb", t: "Save units and practise", d: "Save catalogue units, write practice drafts across the 12-stage task model and manage your learner profile and consent.", rows: ["Saved unit · DB-02", "Draft · BUILD stage", "Draft · TEST stage", "Profile & consent"] },
  ...
  { id: "organizations", label: "Organizations", Icon: Building2, href: "/workspace/organizations", c: "#0d9488", t: "Work as a team", d: "Create an organization, invite members with roles and switch context before working on shared records.", rows: ["Organization", "Members · 4", "Role · admin", "Invitations"] },
