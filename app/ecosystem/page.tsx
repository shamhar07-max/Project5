...
export default function Ecosystem() { return <PublicPage eyebrow="Ecosystem" title="Connected where it helps." intro="Each division has its own work, customers and decisions, with one identity and workspace for authorized activity." sections={[
