...
export default function Ecosystem() { return <PublicPage eyebrow="Ecosystem" title={<>Connected <em>where it helps.</em></>} scene="ecosystemHero" hue={["#8b5cf6", "#22d3ee"]} intro="Each division has its own work, customers and decisions, with one identity and workspace for authorized activity." sections={[
