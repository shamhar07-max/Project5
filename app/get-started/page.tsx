...
export default function GetStarted() {
  return <main className="public-site">
    <SiteHeader />
    <PageHero kicker="Your path · DigitalBurj" title={<>Start with the <em>outcome you need.</em></>} intro="Three quick choices. We will point you to the right team and the channel you prefer — web, mobile or WhatsApp." scene="getStartedHero" hue={["#e10613", "#f59e0b"]} />
