...
export default function Company() { return <PublicPage eyebrow="Company" title="About DigitalBurj" intro="A technology company connecting practical education, engineering, operational improvement and professional capability." sections={[
