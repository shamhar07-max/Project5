...
export default function Privacy(){return <PublicPage eyebrow="Privacy" title={<>Your <em>information.</em></>} art={{ seed: "privacy-hero", variant: "orbit" }} hue={["#f59e0b", "#8b5cf6"]} intro="DigitalBurj needs a reviewed legal privacy notice before public launch. This page explains the current app’s visible data handling, not a final legal policy." sections={[
